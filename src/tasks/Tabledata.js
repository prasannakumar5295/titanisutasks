...
import '../css/Tabledata.css'; // Import custom CSS
  ...
  return (
    <div className="user-list">
      ...
      <input
        ...
        className="search"
      />
      <button className="buttonsearch" onClick={handleFilter}>Search</button>
          ...
          {currentUsers.map((user) => (
            user.id === editId ?
              <tr>
                ...
                <td><input type="text" value={updatedata.email} onChange={e => setUpdatedata({ ...updatedata, email: e.target.value })} /></td>
